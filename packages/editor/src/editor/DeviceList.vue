...
.cg-dev-state { padding: 16px; text-align: center; font-size: 12px; color: #5b6478; }
.cg-dev-error { color: #f87171; }
.cg-dev-row {
  display: flex; align-items: center; gap: 8px; padding: 8px 10px;
  border-radius: 6px; cursor: pointer; color: #c7cee0; font-size: 12px;
}
.cg-dev-row:hover { background: rgba(255, 255, 255, 0.05); }
...
.cg-dev-empty { padding: 16px; text-align: center; color: #5b6478; font-size: 12px; }
</style>
