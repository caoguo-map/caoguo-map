/**
 * 武汉模拟电网数据（Phase 2 电网推演演示用）
 * - 5 级层级：发电（L1）→ 输电（L2）→ 变电（L3）→ 配电（L4）→ 用户（L5）
 * - 设备：火电厂/水电站/光伏电站 + 铁塔 + 变电站 + 配变 + 用户
 * - 线路：500kV 输电 + 220kV 输电 + 10kV 配电
 *
 * 注意：合成数据，仅用于演示。
 */

import type { GridTopologyDataset } from '@caoguo/maplibre-grid';

export const wuhanGrid: GridTopologyDataset = {
  devices: [
    // L1 发电
    ...
    { id: 'tower-t02', kind: 'tower', name: '铁塔 T02', lng: 114.40, lat: 30.60, level: 'L2', properties: { code: 'T02', voltage: '500', status: 'running', commissionYear: 2008 } },
    ...
    // L3 变电站
    { id: 'sub-center', kind: 'substation', name: '汉口中心变电站', lng: 114.30, lat: 30.58, level: 'L3', region: '江岸区', properties: { code: 'SUB-220', voltage: '220', capacity: 720, status: 'running', commissionYear: 2010 } },
    { id: 'sub-guanggu', kind: 'substation', name: '光谷变电站', lng: 114.42, lat: 30.50, level: 'L3', region: '洪山区', properties: { code: 'SUB-110', voltage: '110', capacity: 360, status: 'running', commissionYear: 2015 } },
    ...
    { id: 'trans-a02', kind: 'transformer', name: '配变 A02', lng: 114.32, lat: 30.59, level: 'L4', region: '江岸区', properties: { code: 'PT-002', voltage: '10', capacity: 2.0, status: 'running', loadRate: 0.88, commissionYear: 2012 } },
    { id: 'trans-b01', kind: 'transformer', name: '配变 B01', lng: 114.43, lat: 30.49, level: 'L4', region: '洪山区', properties: { code: 'PT-003', voltage: '10', capacity: 3.0, status: 'running', loadRate: 0.72, commissionYear: 2018 } },
    { id: 'trans-b02', kind: 'transformer', name: '配变 B02', lng: 114.40, lat: 30.52, level: 'L4', region: '洪山区', properties: { code: 'PT-004', voltage: '10', capacity: 2.5, status: 'fault', loadRate: 0.0, commissionYear: 2014 } },
    { id: 'trans-c01', kind: 'transformer', name: '配变 C01', lng: 114.36, lat: 30.37, level: 'L4', region: '江夏区', properties: { code: 'PT-005', voltage: '10', capacity: 2.0, status: 'running', loadRate: 0.35, commissionYear: 2020 } },
  ],
  lines: [
    // 500kV 输电
    ...
    { id: 'dl-04', fromDevice: 'sub-guanggu', toDevice: 'trans-b02', lineType: 'distribution', properties: { voltage: '10', status: 'fault', loadRate: 0.0, commissionYear: 2014 } },
    ...
    // 备用线路（跨区联络）
    { id: 'dl-06', fromDevice: 'sub-center', toDevice: 'sub-guanggu', lineType: 'distribution', properties: { voltage: '110', status: 'standby', loadRate: 0.0, commissionYear: 2015 } },
  ],
  users: [
    { id: 'u01', name: '常青花园小区', kind: 'residential', deviceId: 'trans-a01', lng: 114.29, lat: 30.56, region: '江岸区', scale: 3200 },
    { id: 'u02', name: '汉口火车站', kind: 'important', deviceId: 'trans-a02', lng: 114.32, lat: 30.59, region: '江岸区', scale: 5000, reason: '交通枢纽' },
    { id: 'u03', name: '武汉市中心医院', kind: 'important', deviceId: 'trans-a02', lng: 114.31, lat: 30.58, region: '江岸区', scale: 2000, reason: '医院' },
    { id: 'u04', name: '光谷软件园', kind: 'industrial', deviceId: 'trans-b01', lng: 114.44, lat: 30.49, region: '洪山区', scale: 8000 },
    { id: 'u05', name: '华中科技大学', kind: 'important', deviceId: 'trans-b01', lng: 114.42, lat: 30.51, region: '洪山区', scale: 50000, reason: '高校' },
    { id: 'u06', name: '光谷步行街', kind: 'commercial', deviceId: 'trans-b02', lng: 114.40, lat: 30.50, region: '洪山区', scale: 6000 },
    { id: 'u07', name: '江夏纸坊街道', kind: 'residential', deviceId: 'trans-c01', lng: 114.36, lat: 30.37, region: '江夏区', scale: 4000 },
  ],
};

/** 设备 ID 列表（供下拉选择） */
export const gridDeviceIds = wuhanGrid.devices.map((d) => d.id);

/** 线路 ID 列表（供停电分析选择） */
export const gridLineIds = wuhanGrid.lines.map((l) => l.id);
