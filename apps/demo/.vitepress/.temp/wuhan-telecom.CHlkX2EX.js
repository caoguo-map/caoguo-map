const wuhanTelecom = {
  baseStations: [
    { id: "bs-m1", type: "macro", name: "移动宏站-汉口", carrier: "中国移动", lng: 114.3, lat: 30.58, properties: { technology: "5G", frequency: "3.5GHz", powerDbm: 46, heightM: 30, azimuth: [0, 120, 240], tilt: 6, status: "online", userCount: 150, throughputMbps: 500, region: "江汉" } },
    { id: "bs-m2", type: "macro", name: "移动宏站-光谷", carrier: "中国移动", lng: 114.42, lat: 30.5, properties: { technology: "5G", frequency: "2.6GHz", powerDbm: 46, heightM: 28, azimuth: [0, 120, 240], tilt: 5, status: "online", userCount: 200, throughputMbps: 600, region: "洪山" } },
    ...
    { id: "bs-g1", type: "micro", name: "广电微站-江岸", carrier: "中国广电", lng: 114.28, lat: 30.6, properties: { technology: "4G", frequency: "700MHz", powerDbm: 30, heightM: 15, azimuth: [0], tilt: 4, status: "online", userCount: 60, throughputMbps: 100, region: "江岸" } }
  ],
  coverageAreas: [
...
const wuhanSignalSamples = [
  { lng: 114.3, lat: 30.58, rsrp: -70 },
  { lng: 114.31, lat: 30.575, rsrp: -82 },
  { lng: 114.42, lat: 30.5, rsrp: -68 },
  { lng: 114.33, lat: 30.56, rsrp: -112 },
  { lng: 114.35, lat: 30.55, rsrp: -120 },
  { lng: 114.3, lat: 30.55, rsrp: -95 },
  { lng: 114.28, lat: 30.6, rsrp: -78 },
  { lng: 114.4, lat: 30.53, rsrp: -108 }
];
wuhanTelecom.baseStations.map((s) => s.id);
export {
  wuhanSignalSamples as a,
  wuhanTelecom as w
};
